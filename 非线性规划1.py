...
try:
    ...
    # Set objective
    m.setObjective(x1*x1+x2*x2+x3*x3+8, GRB.MINIMIZE)

    # Add constraint: x + 2 y + 3 z <= 4
    m.addConstr(x1*x1 - x2 + x3*x3 >=0, "c0")

    # Add constraint: x + y >= 1
    m.addConstr(x1+x2*x2+x3*x3<=20,'c1')
    m.addConstr(-1* x1-(x2*x2)+2==0,'c2')
    m.addConstr(x2+2*x3*x3==3,'c3')
